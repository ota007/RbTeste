<div class="card">
	<div class="card-header text-white bg-dark">
		<span class="card-title">
			<?php echo __('Confirm Sending Email to').' '.$user['first_name'].' '.$user['last_name'];?>
		</span>

		<span class="card-title float-right">
			<?php echo $this->Html->link(__('Edit', true), ['action'=>'sendToUser', $userId], ['class'=>'btn btn-secondary btn-sm']);?>
		</span>
	</div>
